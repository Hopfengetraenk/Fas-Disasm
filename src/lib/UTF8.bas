...
'-------------------------------------------------------------------------
Public Function UToA(ByVal sValue As String, Optional LCID) As String
...
'-------------------------------------------------------------------------
Public Function AToU(ByVal sValue As String, Optional LCID) As String
